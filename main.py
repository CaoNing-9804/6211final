...
from trainer.trainer import Trainer, model_evaluate, CN_get_embedding
...
if training_mode == "self_supervised":
    exec(f'from config_files.{data_type}_Configs import Config_self_supervised as Configs_ss')
    configs = Configs_ss()
    .36

elif training_mode == "random_init":
    exec(f'from config_files.{data_type}_Configs import Config_random_init as Configs_rdi')
    configs = Configs_rdi()

elif training_mode == "train_linear":
    exec(f'from config_files.{data_type}_Configs import Config_train_linear as Configs_tl')
    configs = Configs_tl()
...
model_type = configs.basemdl
exec(f'from models.model_{model_type} import base_Model as base_Model')
...
if training_mode == "CN_embedding":
    ...
    CN_get_embedding(model, temporal_contr_model, train_dl, device)
    sys.exit(0)
